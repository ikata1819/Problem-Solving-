...
// if(role=="Regular_user"){
    ...
    outfile<<userHandle<<endl<<userName<<endl<<countryName<<endl<<institution<<endl;
    // }
...
void AdminUser::manageUser()
{
    ...
    string handle, name, country, institution;
...
//        cout << "Do you want to go to main menu? Press 'y' if YES. 'n' otherwise" << endl;
//        cin >> ch;
