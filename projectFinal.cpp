...
public:
    ...
    void ask_question(int questionNumber) const
    {
        ...
        cout << "Answer: " << it->second << endl<<endl;
    ...
    void manage_mp1()
    {
             ...
             while(!isINT(operation,0,3))
        {
            ...
            case 3:
                ...
                break;
            case 0:
                cout << "Exiting Astronaut Article........\n" << endl;
                return;
            default:
                cout << "Invalid choice. Please try again." << endl;
            }
    ...
    void viewArticle()
    {
        ...
        do
        {
            ...
            if(ch == 1)
            {
                ...
                int cho;
                article.mp_1_show();
                cout << "Select an Astronaut(1-10).[press 0 to exit]" << endl;
                cin >> u_input1;
                while(!isINT(u_input1,0,10))
        {
            cout<<"Invalid input\n";
            cout << "Enter your choice" << endl;
            cin >> u_input1;
            ...
            else if(ch == 2)
            {
                ...
                int cho2;
                article.mp_2_show();
                cout << "Select a Space Exploration(1-10).[press 0 to exit]" << endl;
                cin >> u_input2;
                  while(!isINT(u_input2,0,10))
        {
            cout<<"Invalid input\n";
            cout << "Enter your choice" << endl;
            cin >> u_input2;
        ...
        while(ch1 == 'y' || ch1 == 'Y');
        cout << "Exiting Article class....." <<endl<< endl;
        system("cls");
        Sleep(1000);
        title();
    }
...
void adminmenu()
{
    ...
    cout << "[2] Manage FAQ" << endl;
    cout << "[3] Manage ARTICLE" << endl;
    cout << "[4] View User List" << endl;
    cout << "[5] LOGOUT" << endl<<endl;

    int choice2;
    char ch1;
    cin >> choice2;
    while(!isINT(choice2,1,5))
        {
            cout<<"Invalid input\n";
            cout << "Enter your choice" << endl;
            cin >> choice2;
